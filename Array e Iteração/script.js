...
const arrayCursos = Array.from(cursos) //Conversão de NodeList para Array

const objetoCursos = arrayCursos.map((item) => {
...
const verificacaoBaixo = instrumentos.some(item => item === 'Baixo')
